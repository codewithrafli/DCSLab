...
class NonCapitalWithdrawalAPIReadTest extends APITestCase
{
    ...
    public function test_non_capital_withdrawal_api_call_read_any_without_authorization_expect_unauthorized_message()
    {
        ...
        $api = $this->getJson(route('api.get.db.product.non_capital_withdrawal.read_any', [
    ...
    public function test_non_capital_withdrawal_api_call_read_without_authorization_expect_unauthorized_message()
    {
        ...
        $api = $this->getJson(route('api.get.db.product.non_capital_withdrawal.read', $ulid));
    ...
    public function test_non_capital_withdrawal_api_call_read_without_ulid_expect_exception()
    {
        ...
        $this->getJson(route('api.get.db.product.non_capital_withdrawal.read', null));
    }
