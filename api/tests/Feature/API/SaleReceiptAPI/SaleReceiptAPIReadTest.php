...
class SaleReceiptAPIReadTest extends APITestCase
{
    ...
    public function test_sale_receipt_api_call_read_any_without_authorization_expect_unauthorized_message()
    {
        ...
        $api = $this->getJson(route('api.get.db.product.sale_receipt.read_any', [
    ...
    public function test_sale_receipt_api_call_read_without_authorization_expect_unauthorized_message()
    {
        ...
        $api = $this->getJson(route('api.get.db.product.sale_receipt.read', $ulid));
    ...
    public function test_sale_receipt_api_call_read_without_ulid_expect_exception()
    {
        ...
        $this->getJson(route('api.get.db.product.sale_receipt.read', null));
    }
