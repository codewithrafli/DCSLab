...
class PurchaseAdditionalCostCategoryAPIReadTest extends APITestCase
{
    ...
    public function test_purchase_additional_cost_category_api_call_read_any_without_authorization_expect_unauthorized_message()
    {
        ...
        $api = $this->getJson(route('api.get.db.product.purchase_additional_cost_category.read_any', [
    ...
    public function test_purchase_additional_cost_category_api_call_read_without_authorization_expect_unauthorized_message()
    {
        ...
        $api = $this->getJson(route('api.get.db.product.purchase_additional_cost_category.read', $ulid));
    ...
    public function test_purchase_additional_cost_category_api_call_read_without_ulid_expect_exception()
    {
        ...
        $this->getJson(route('api.get.db.product.purchase_additional_cost_category.read', null));
    }
