                ...
                <div class="p-5 grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div class="pb-4">
                        ...
                        <FormInput v-model="customerGroupForm.max_open_invoice" type="number"
                            :class="{ 'border-danger': customerGroupForm.invalid('max_open_invoice') }"
                    ...
                    <div class="pb-4">
                        ...
                        <FormInput v-model="customerGroupForm.max_outstanding_invoice" type="number"
                            :class="{ 'border-danger': customerGroupForm.invalid('max_outstanding_invoice') }"
                    ...
                    <div class="pb-4">
                        ...
                        <FormInput v-model="customerGroupForm.max_invoice_age" type="number"
                            :class="{ 'border-danger': customerGroupForm.invalid('max_invoice_age') }"
                    ...
                    <div class="pb-4">
                        ...
                        <FormSelect v-model="customerGroupForm.payment_term_type"
                            :class="{ 'border-danger': customerGroupForm.invalid('payment_term_type') }"
                    ...
                    <div class="pb-4 col-span-1 md:col-span-2">
                        ...
                        <FormInput v-model="customerGroupForm.payment_term" type="number"
                            :class="{ 'border-danger': customerGroupForm.invalid('payment_term') }"
            ...
            <template #card-items-2>
                <div class="p-5">
                    <div class="pb-4 grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            <FormLabel :class="{ 'text-danger': customerGroupForm.invalid('selling_point') }">
                                {{ t('views.customer_group.fields.selling_point') }}
                            </FormLabel>
                            <FormInput v-model="customerGroupForm.selling_point" type="number"
                                :class="{ 'border-danger': customerGroupForm.invalid('selling_point') }"
                                @change="customerGroupForm.validate('selling_point')" />
                            <FormErrorMessages :messages="customerGroupForm.errors.selling_point" />
                        </div>
                        <div>
                            <FormLabel :class="{ 'text-danger': customerGroupForm.invalid('selling_point_multiple') }">
                                {{ t('views.customer_group.fields.selling_point_multiple') }}
                            </FormLabel>
                            <FormInput v-model="customerGroupForm.selling_point_multiple" type="number"
                                :class="{ 'border-danger': customerGroupForm.invalid('selling_point_multiple') }"
                    ...
                    <div class="pb-4 grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <FormInput v-model="customerGroupForm.price_markup_percent" type="number"
                                :class="{ 'border-danger': customerGroupForm.invalid('price_markup_percent') }"
                        ...
                        <div>
                            ...
                            <FormInput v-model="customerGroupForm.price_markup_nominal" type="number"
                                :class="{ 'border-danger': customerGroupForm.invalid('price_markup_nominal') }"
                        ...
                        <div>
                            ...
                            <FormInput v-model="customerGroupForm.price_markdown_percent" type="number"
                                :class="{ 'border-danger': customerGroupForm.invalid('price_markdown_percent') }"
                        ...
                        <div>
                            ...
                            <FormInput v-model="customerGroupForm.price_markdown_nominal" type="number"
                                :class="{ 'border-danger': customerGroupForm.invalid('price_markdown_nominal') }"
